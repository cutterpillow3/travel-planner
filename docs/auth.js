document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupPopupClose(popupDiv, overlayDiv, closeButtonId) {
        ...
        if (closeButton) 
            closeButton.addEventListener('click', () => togglePopup(popupDiv, overlayDiv, false));
        if (overlayDiv) 
            overlayDiv.addEventListener('click', () => togglePopup(popupDiv, overlayDiv, false));
    }
    ...
    function togglePopup(popupDiv, overlayDiv, isVisible) {
        if (popupDiv) 
            popupDiv.style.display = isVisible ? 'block' : 'none';
        if (overlayDiv) 
